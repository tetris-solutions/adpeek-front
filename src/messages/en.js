module.exports = {
  ...
  facebookBudgetDisallowInsert: 'It is not possible to add more than one campaign to a <strong>Facebook</strong> budget',
  ...
  loadingUserLists: 'Loading user lists...',
  loadingAdGroups: 'Loading AdGroups...',
  loadingProductPartitions: 'Loading product partitions...',
  loading: 'Loading...',
  saving: 'Saving...',
  ...
  editFolderAccount: 'Folder Account',
  ...
  leaveCreativesPrompt: 'If you leave now all your changes will be lost. Are you sure you want to do this?',
  ...
  emptyAccountDetails: 'This type of account is not yet available for edit',
  ...
  salesCountryLabel: 'Sales country',
  merchantLabel: 'Merchant Account',
  ...
  productBiddingCategoryL1: 'Category (level 1)',
  productBiddingCategoryL2: 'Category (level 2)',
  productBiddingCategoryL3: 'Category (level 3)',
  productBiddingCategoryL4: 'Category (level 4)',
  productBiddingCategoryL5: 'Category (level 5)',
  productBrand: 'Brand',
  productOfferId: 'Item ID',
  productCanonicalCondition: 'Condition',
  productProductTypeL1: 'Product type (level 1)',
  productProductTypeL2: 'Product type  (level 2)',
  productProductTypeL3: 'Product type  (level 3)',
  productProductTypeL4: 'Product type  (level 4)',
  productProductTypeL5: 'Product type  (level 5)',
  productCustomAttribute0: 'Custom attribute 0',
  productCustomAttribute1: 'Custom attribute 1',
  productCustomAttribute2: 'Custom attribute 2',
  productCustomAttribute3: 'Custom attribute 3',
