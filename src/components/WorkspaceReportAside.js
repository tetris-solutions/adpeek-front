...
export function WorkspaceReportAside ({report, dispatch, user}, {messages, locales, router, location: {pathname, search}, params}) {
  ...
  const reportUrl = `${workspaceUrl}/report/${report.id}`
